    ...
    <div className='items-center justify-end -pt-20 md:pb-24 lg:pb-40'>
      ...
      <Container>
        <div className='absolute top-[38%] sm:top-[40%] md:top-[45%] -translate-y-1/2 lg:-translate-y-[60%] xl:-translate-y-[75%] lg:mt-[5%] text-white'>
          <FromLeft className='text-[26px] leading-[30px] sm:eading-9 sm:text-3xl md:text-4xl 900:text-5xl lg:text-6xl font-bold md:leading-[45px] 900:leading-[55px] lg:leading-[70px] w-[65%] sm:w-[55%] md:w-[45%] 900:w-[60%] tracking-tight mb-4 xs:mb-4'>
            Explore, <br /> Ride, Repeat
          </FromLeft>

          <FromLeft className='text-sm  md:text-base w-[80%] sm:w-[75%] md:w-[60%] sm:text-lg md:leading-[25px] text-stone-200 mb-8 '>
          ...
          <FromLeft>
            ...
            <div className='md:inline-block '>
              <div className='relative mt-4 z-20'>
                <input
                  className='pl-12 z-20 dark:border-stone-400  pr-6 outline-none  py-2.5 sm:py-3.5 rounded-xl bg-black border text-white md:w-[300px] mt-3 md:mt-0'
                  type='text'
