...
export default function CouponManage() {
  ...
  return (
    <div>
      <AddCouponModal />
      <div className='border border-stone-200 text-xs sm:text-sm font-semibold rounded-b-none text-stone-800 rounded-lg py-4 px-4 md:px-6 lg:px-10 flex justify-between items-center mt-10 bg-stone-100'>
