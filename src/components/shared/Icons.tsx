...
export const Facebook = ({ bg = '#FF4500', fill = 'white' }) => (
  <svg
    width='28'
    height='28'
    viewBox='0 0 28 28'
...
export const WhatsApp = ({ bg = '#FF4500', fill = 'white' }) => (
  <svg
    width='28'
    height='28'
    viewBox='0 0 28 28'
...
export const Instagram = ({ bg = '#FF4500', fill = 'white' }) => (
  <svg
    width='28'
    height='28'
    viewBox='0 0 28 28'
...
export const LinkedIn = ({ bg = '#FF4500', fill = 'white' }) => (
  <svg
    width='28'
    height='28'
    viewBox='0 0 28 28'
