...
export default function Sidebar() {
  ...
  return (
    <div className='relative'>
      ...
      <div
        className={`fixed top-0 left-0 h-screen 900:w-56 lg:w-64 dark:bg-secondary-color bg-white py-9 px-4  z-40 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className='flex justify-between items-center mb-4'>
          ...
          <button onClick={dark}>
            {isDark ? (
              <svg
                className='swap-on fill-black w-7 h-7 mt-1'
              ...
              <svg
                className='swap-off fill-white w-7 h-7 mt-1'
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 24 24'
              >
